...
CONTEXT = {
    ...
    "TeamName": "UH-Top",
    "Event": "ICPC Caribbean Finals 2024",
    "TeamMembers": [
        "Ariel Gonzales Gomez ",
        "Jorge Pichardo Cabrera",
...
def main():
    with open("d:/Programming/Competitive programming/ICPC-WF-2023-UH-Top/extended team reference/template.tex") as f:
        template = f.read()
    ...
    if COMPILE:
        subprocess.call(["pdflatex", "-synctex=1", "-interaction=nonstopmode", "d:/Programming/Competitive programming/ICPC-WF-2023-UH-Top/extended team reference/reference.tex"])
